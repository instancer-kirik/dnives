...
// DCore class is defined in dcore.core module
...
class CCCore {
    ...
    /// Constructor
    this(ConfigManager config, DCore dcore = null) {
    ...
    private void initManagers() {
        ...
        if (dcore !is null && mainWindow !is null) {
            initializeNotebookSystem(dcore, this, mainWindow);
        }
    ...
    /// Set DCore reference
    public void setDCore(DCore dcore) {
        this.dcore = dcore;
    }
