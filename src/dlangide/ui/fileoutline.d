...
class FileOutlineWidget : VerticalLayout {
    ...
    bool delegate(FileSymbol) onSymbolDoubleClicked;
    bool delegate(FileSymbol, string) onSymbolRenamed;
    bool delegate(FileSymbol[]) onOutlineUpdated;
    ...
    private void createToolbar() {
        ...
        _searchField.tooltipText = "Search symbols..."d;
    ...
    private void createOutlineTree() {
        ...
        // Note: TreeWidget configuration properties disabled
        // These properties don't exist in the current dlangui version
    }
    ...
    private void setupEventHandlers() {
        ...
        // Sort combo handler - using itemClick instead of onSelectionChange
        _sortCombo.itemClick = delegate(Widget source, int itemIndex) {
    ...
    private double calculateSymbolQuality(FileSymbol symbol) {
        ...
        final switch (symbol.type) {
            ...
            case SymbolType.Mixin:
            case SymbolType.Alias:
            case SymbolType.Comment:
            case SymbolType.Region:
                // No adjustment for these types
                break;
        }
...
class OutlineSettingsDialog : Dialog {
    ...
    bool delegate(OutlineConfig) onConfigChanged;
