...
// Test basic dcore imports
import dcore.config;

mixin APP_ENTRY_POINT;

/// Minimal test entry point for dnives
extern (C) int UIAppMain(string[] args)
{
    ...
    Log.i("Dnives Minimal Test - Starting up");
    ...
    else
    {
        try
        {
            ...
            Log.i("ConfigManager created successfully");

            // Create a simple window to test
            Window window = Platform.instance.createWindow("Dnives Test", null,
            ...
            content.addChild(new TextWidget("test_label", "Dnives Core Test - Architecture Integration"d));
            content.addChild(new Button("test_button", "Test Button"d));
            ...
            Log.i("Dnives minimal test ready - entering message loop");

            // Run message loop
            int result = Platform.instance.enterMessageLoop();

            Log.i("Shutting down test app");
            return result;
        }
        catch (Exception e)
        {
            Log.e("Fatal error during test startup: ", e.msg);
            return 1;
        }
    }
}
